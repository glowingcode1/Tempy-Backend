...
const apiRateLimiterTwoFADisable = createRateLimiter(
  "/users/twofa/disable",
  2,
  30,
); // 2 requests per 30 minutes
...
router.get("/", apiRateLimiterUsers, roleMiddleware(["admin"]), getUsers);
